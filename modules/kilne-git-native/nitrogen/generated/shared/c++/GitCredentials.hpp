...
namespace margelo::nitro::kilne::git {
  ...
  /**
   * A struct which can be represented as a JavaScript object (GitCredentials).
   */
  struct GitCredentials final {
  public:
  ...
  public:
    ...
    explicit GitCredentials(std::string username, std::string password): username(username), password(password) {}

  public:
    friend bool operator==(const GitCredentials& lhs, const GitCredentials& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ GitCredentials <> JS GitCredentials (object)
  template <>
  struct JSIConverter<margelo::nitro::kilne::git::GitCredentials> final {
    static inline margelo::nitro::kilne::git::GitCredentials fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::kilne::git::GitCredentials(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::kilne::git::GitCredentials& arg) {
